...
using MonoGameMPE.Mercury.ParticleEngine.Core.Profiles;
...
namespace MonoGameMPE.Mercury.ParticleEngine.Core {
    public unsafe class Emitter : IDisposable {
        ...
        private void ReclaimExpiredParticles() {
            ...
            // BUG: Reclaim sometimes takes particles that it shouldn't
        ...
        private void Release(Coordinate position, int numToRelease) {
            ...
            while (count-- > 0) {
                ...
                particle->TriggerPos[0] = position._x;
                particle->TriggerPos[1] = position._y;
